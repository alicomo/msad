<!-- start content -->
	<div id="content">
		<div class="post">
			...
			<div class="entry">
				<p><strong>News Flash</strong> is a free, fully standards-compliant CSS template designed by <a href="http://www.freecsstemplates.org/">Free CSS Templates</a>. This free template is released under a <a href="http://creativecommons.org/licenses/by/2.5/">Creative Commons Attributions 2.5</a> license, so you're pretty much free to do whatever you want with it  (even use it commercially) provided you keep the links in the footer  intact. Have fun with it :)</p>
					...
					<table summary="Calendar">
						...
						<tfoot>
							<tr>
								...
								<td class="pad">&nbsp;</td>
								<td abbr="November" colspan="3" id="next"><a href="#" title="View posts for November 2007">Nov &raquo;</a></td>
							</tr>
						</tfoot>
						<tbody>
							<tr>
